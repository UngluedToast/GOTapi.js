// const URL = "https://my-little-cors-proxy.herokuapp.com/https://anapioficeandfire.com/api/characters/583"
...
function loadCharacters() {
    ...
    if (arrayOfCharacters ) {
        ...
        console.log('No characters in localStoarge');
    }
